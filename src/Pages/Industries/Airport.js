...
Employee supervision, machine/asset tracking, visitor averages comparison over time, unique versus repeating passengers, country of origin of your visitors, real time traffic data and trends…</p>
  ...
  <div class="col-md-2">
    <div class="card border-light">
      ...
      <div class="card-body">
      <Link to="/shopping-centres" class="btn btn-primary">Shopping</Link>
  ...
  <div class="col-md-2">
    <div class="card border-light">
      ...
      <div class="card-body">
      <Link to="airports" class="btn btn-primary">Airports</Link>
  ...
  <div class="col-md-2">
    <div class="card border-light">
      ...
      <div class="card-body">
      <Link to="/transportation" class="btn btn-primary">Transportation</Link>
...
Engage with passengers, optimize train scheduling and make better use of your spaces</p>
  ...
  <div class="col-md-2">
    <div class="card border-light">
      ...
      <div class="card-body">
      <Link to="/cities" class="btn btn-primary">Cities</Link>
  ...
  <div class="col-md-2">
    <div class="card border-light">
      ...
      <div class="card-body">
      <Link to="/hospitality" class="btn btn-primary">Hospitality</Link>
