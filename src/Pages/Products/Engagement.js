...
function Engagement() {
  return <div>
    ...
    <div id='enga-hero' className="container-fluid bg-dark text-white px-5">
...
Engagement</h1>
  ...
  <div className="container-fluid  p-5" style = {{backgroundColor: '#f2f2f2'}}>
      ...
      <div className="col-lg-6">
        ...
        <p>The relationship between the business and its customers is elevated through engagement.<br/>
...
Ariadne Engagement allows you to give personalized offers and valuable product information to your customers in real time when they need it the most.
      ...
      <div className="col-lg-4">
        ...
        <div class=" container-fluid p-5 mb-5 bg-black text-white text-center font-weight-bold align-items-center">
            ...
            <div className="row align-items-center justify-content-center">
              <div className="col-8">
              <h1 class='mb-5'>Here is an example</h1>
          ...
          <div className="container my-4">
            <div className="row align-items-center justify-content-between">
              ...
              <div className="col-lg-5">
                <h3 className='mb-2'>All-in-One Platform</h3>
                <h6>Ariadne connects the data from your store to your CRM system, allowing you to run targeted marketing campaigns. Ariadne also assists for a complete perspective of consumer behavior that includes both online and on-premises activity.</h6>

                <h3 className='mb-2'>Design Efficient Campaigns </h3>
                <h6>Measure the success of your campaigns, e.g., a temporary theme park, and compare results</h6>
                </div>
                <div className="col-lg-6">
      ...
      <div className="container" id='enga-end'>
